...
<html lang='en'>
    <head>
        ...
        <title>Code Portofolio Djody Kort</title>
    </head>
    <body class='index-body'>
        <div class='navbar'>
            <a href='./html/nl/index.php'><img  src='./images/NL_Flag.png' alt='Look for the NLFlag.jpeg'></a>
        </div>
        ...
        <div class='footer'>
            ...
            <div>
                <a href='./html/en/projects.php' class='footer-link'>
